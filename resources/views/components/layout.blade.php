...
<aside class="md:fixed w-1/12 bg-white h-screen flex gap-4 flex-col">
   <div class="p-8">
   ...
   <nav class="flex flex-col gap-2">
      <ul class="flex flex-col p-0 gap-4">
         <li class="p-0">
            <a href="{{url('/')}}" class="flex items-center w-full  md:py-4 md:px-10 bg-red-100 gap-2 hover:font-bold">
