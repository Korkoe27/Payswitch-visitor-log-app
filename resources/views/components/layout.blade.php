...
<body class="flex md:flex-row flex-col md:gap-4 bg-[#f9fafb]">
    ...
    <aside class="md:fixed  lg:w-[12%] bg-white h-screen flex gap-4 py-4 flex-col">
        <div class="p-8">
        ...
        <nav class="flex flex-col gap-2">
            ...
            <div class="  flex items-center absolute mx-auto lg:bottom-10 lg:right-1/4 p-4 gap-4 rounded-lg h-fit w-fit ">
    ...
    <main class="w-11/12 lg:ml-[11%]">
        ...
        <!-- ====== Navbar Section End -->
        <section class="bg-[rgba(0,0,0,_0.4)] px-6">
            {{ $slot }}
        </section>
    </main>
