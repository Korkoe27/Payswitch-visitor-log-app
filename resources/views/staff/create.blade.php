        ...
        <form action="{{url('store-staff')}}" method="POST" class="flex p-5 w-full overflow-hidden">
            ...
            <aside class="w-1/2">
                <div class="w-full px-4 md:w-1/2 lg:w-1/2">
                    <div class="mb-12">
                       ...
                       <input type="text" placeholder="Jane" id="first_name" name="first_name" required class="w-full bg-transparent rounded-md border border-slate-400 py-5 px-5 text-dark-6 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 disabled:border-gray-2" />
                    </div>
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/2">
                    <div class="mb-12">
                       ...
                       <input type="text" placeholder="Abla" id="other_name" name="other_name" class="w-full bg-transparent rounded-md border border-slate-400 py-5 px-5 text-dark-6 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 disabled:border-gray-2" />
                    </div>
                    {{-- @error('vehicle_number')
                    <div class="text-red-500 italic font-normal text-sm">{{ $message }}</div>
                    @enderror --}}
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/2">
                    <div class="mb-12">
                       ...
                       <input type="text" placeholder="Doe" id="last_name" name="last_name" required class="w-full bg-transparent rounded-md border border-slate-400 py-5 px-5 text-dark-6 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 disabled:border-gray-2" />
                    </div>
                    {{-- @error('vehicle_number')
                    <div class="text-red-500 italic font-normal text-sm">{{ $message }}</div>
                    @enderror --}}
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/2">
                    <div class="mb-12">
                       ...
                       <input type="text" placeholder="GR 1000 25" id="employee_number" required name="employee_number" class="w-full bg-transparent rounded-md border border-slate-400 py-5 px-5 text-dark-6 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 disabled:border-gray-2" />
                    </div>
                    {{-- @error('vehicle_number')
                    <div class="text-red-500 italic font-normal text-sm">{{ $message }}</div>
                    @enderror --}}
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/2">
                    <div class="mb-12">
                       ...
                       <input type="text" placeholder="janedoe@payswitch.com.gh" id="email" name="email" class="w-full bg-transparent rounded-md border border-slate-400 py-5 px-5 text-dark-6 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 disabled:border-gray-2" />
                    </div>
                    {{-- @error('vehicle_number')
                    <div class="text-red-500 italic font-normal text-sm">{{ $message }}</div>
                    @enderror --}}
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/2">
                    <div class="mb-12">
                       ...
                       <input type="text" placeholder="0241234567" id="phone_number" required name="phone_number" class="w-full bg-transparent rounded-md border border-slate-400 py-5 px-5 text-dark-6 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 disabled:border-gray-2" />
                    </div>
                    {{-- @error('vehicle_number')
                    <div class="text-red-500 italic font-normal text-sm">{{ $message }}</div>
                    @enderror --}}
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/2">
                <div class="mb-12">
                   ...
                   <input type="text" placeholder="Software Engineer" id="job_title" required name="job_title" class="w-full bg-transparent rounded-md border border-slate-400 py-5 px-5 text-dark-6 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 disabled:border-gray-2" />
                </div>
                {{-- @error('vehicle_number')
                <div class="text-red-500 italic font-normal text-sm">{{ $message }}</div>
                @enderror --}}
