...
<body class="flex w-full justify-center items-center h-screen">
    <main class="flex flex-col lg:gap-24">
        <div class="flex m-auto">
            <img src={{asset('logo.png')}} alt="" class="lg:w-56">
        </div>
        <section class="lg:p-12 bg-[#f5f5f5] flex flex-col rounded-3xl lg:gap-12">
            <h1 class="text-center font-bold lg:text-3xl text-[#201f21]">
                Login to your Account
            </h1>
            <form action="" class="flex flex-col lg:gap-10">
                <div class="lg:w-96">
                    <label for="email" class="capitalize text-[#44546f] font-semibold text-lg">email</label>
                    <input type="email" name="email" id="email" class="w-full border outline-none border-[#091e4223] lg:p-3 bg-white" placeholder="johndoe@payswitch.com.gh">
                </div>
                <div class="lg:w-96">
                    <label for="password" class="capitalize text-base text-[#44546f] font-semibold">password</label>
                <div class="lg:w-96 bg-white border border-[#091e4223]">
                    <div class="w-full lg:px-1 flex items-center">
                      <input type="password" name="password" id="password" class="w-full text-lg outline-none lg:p-3 bg-white" placeholder="...........">
                ...
                <button class="w-full rounded p-3 bg-gradient-to-b from-[#247efc] to-[#0c66e4] text-white ">Login</button>
            </form>
        </section>
    </main>
