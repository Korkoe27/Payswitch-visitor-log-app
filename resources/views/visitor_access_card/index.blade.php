<x-layout>
    ...
    <div class="flex justify-self-end md:px-6 ">
        <a href="{{url('create-access-card')}}" class="flex border border-green-900 w-full rounded-md items-center text-green-900 md:p-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
